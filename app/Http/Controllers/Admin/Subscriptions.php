...
$sheet->setCellValue('AB' . ($key + 2), $addressParts[1] ?? '');
    ...
    public function printSchedule2()
    {
        $config = DB::table('config')->first();
        $data = Subscription::with('user');
        ...
        return view('admin.pages.subscriptions.print2', compact('dates', 'cities', 'data'));
    }
    ...
    public function stats()
    {
        ...
        return view('admin.pages.subscriptions.stats', compact('dates', 'cities', 'data'));
    }
