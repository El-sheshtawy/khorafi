                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th><div style="display: flex; justify-content: space-between; align-items: center;"><span>{{trans('web.male_short')}}</span><span style="font-size: 11px; color: #28a745;">(ك/غ)</span></div></th>
                            <th><div style="display: flex; justify-content: space-between; align-items: center;"><span>{{trans('web.female_short')}}</span><span style="font-size: 11px; color: #28a745;">(ك/غ)</span></div></th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            @foreach(\App\City::get() as $city)
                                ...
                                @if($rowCount % 6 == 0)
                                    <tr style="color:white;background-color:#369bdd">
                                        ...
                                        <td>
                                            <div style="display: flex; flex-direction: row-reverse; justify-content: space-between; align-items: center;">
                                                <span style="color: white; font-size: 11px;">{{$totalNonKuwaitiMales}}/{{$totalKuwaitiMales}}</span>
                                                <strong style="color:white">{{$totalMales}}</strong>
                                            </div>
                                        </td>
                                        <td>
                                            <div style="display: flex; flex-direction: row-reverse; justify-content: space-between; align-items: center;">
                                                <span style="color: white; font-size: 11px;">{{$totalNonKuwaitiFemales}}/{{$totalKuwaitiFemales}}</span>
                    ...
                    <tbody>
                        ...
                        @foreach(\App\City::get() as $city)
                            @foreach(\App\SubscriptionsName::get() as $category)
                                ...
                                <?php $previousCity = $city->name_ar; $rowCount++; if($rowCount % 4 == 0) { echo '<tr style="border-bottom: 2px solid black;background-color:#369bdd"><th style="color:white">الاجمالي</th><td style="color:white"></td><td><div style="display: flex; flex-direction: row-reverse; justify-content: space-between;"><span style="color: white; font-size: 11px;">' . $totalNonKuwaitiMales . '/' . $totalKuwaitiMales . '</span><strong style="color:white">' . $totalMales . '</strong></div></td><td><div style="display: flex; flex-direction: row-reverse; justify-content: space-between;"><span style="color: white; font-size: 11px;">' . $totalNonKuwaitiFemales . '/' . $totalKuwaitiFemales . '</span><strong style="color:white">' . $totalFemales . '</strong></div></td><td><strong style="color:white">' . $totalSubscribers . '</strong></td></tr>'; $totalSubscribers = 0; $totalMales = 0; $totalFemales = 0; $totalKuwaitiMales = 0; $totalNonKuwaitiMales = 0; $totalKuwaitiFemales = 0; $totalNonKuwaitiFemales = 0; } ?>
                            @endforeach
                        @endforeach
                    </tbody>
                    <tfoot>
