        ...
        <div class="slider__wrapper swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="single-slider swiper-slide slider__height d-flex align-items-end justify-content-center" style="background: #000; position: relative; overflow: hidden;">
                    <video id="sliderVideo" playsinline preload="auto" controls style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; z-index: 1;">
                        <source src="{{url('website/public/videos/' . $config->slider_video)}}" type="video/mp4">
                    </video>
                ...
                <div class="single-slider swiper-slide slider__height slider__overlay d-flex align-items-end justify-content-center" data-background="{{url('website/public/images/' . $val->image)}}" style="background-size: contain; background-position: center;">
                    <div class="container">
                        <div class="row">
                            <div class="col-12 text-center" style="margin-bottom: 50px;">
                                <div class="slider__content">
