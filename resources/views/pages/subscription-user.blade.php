...
<main>
    ...
    <style>
        ...
        .user-table td:first-child { color: #667eea; font-size: 15px; width: 200px; background: #f8f9fa; text-align: right; }
        ...
        @media (max-width: 768px) {
            ...
            .user-table td:first-child { font-size: 13px; width: 40%; text-align: right; }
