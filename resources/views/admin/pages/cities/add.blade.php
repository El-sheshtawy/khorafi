            ...
            <form class="" method="post" action="" enctype="multipart/form-data">
                <div class="page-title-box">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item active">التحكم بالمحافظات</li>
                    </ol>
                    <h4 class="page-title">التحكم بالمحافظات</h4>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">إضافة محافظة</h5>
                                <div class="row">
                                    <div class="col-md-12">
                                        @if (session('success'))
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br><br>
                                <a class="btn btn-danger btn-block" href="{{url('/')}}/admin/cities">رجوع</a>
                            </div>
                        </div>
