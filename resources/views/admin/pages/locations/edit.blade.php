            ...
            <form class="" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">تعديل مقر مسابقة</h5>
                                <div class="row">
                                    <div class="col-md-12">
                                        @if (session('success'))
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div>
                                            <input class="form-control" type="text" name="body_ar" value="{{$data->body_ar}}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <div>
                                            <input class="form-control" type="text" name="body_en" value="{{$data->body_en}}" />
                                        </div>
                                    </div>
