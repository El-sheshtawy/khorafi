            ...
            <form class="" method="post" action="" enctype="multipart/form-data">
                <div class="page-title-box">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item active">التحكم بالتصنيفات</li>
                    </ol>
                    <h4 class="page-title">التحكم بالتصنيفات</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card" style="margin-bottom: 20px">
                            <div class="card-body">
                                <h5 class="card-title">الايقونة</h5>
                                <div>
                                    <input type="file" id="input-file-max-fs" name="icon" class="dropify" data-max-file-size="2M" data-default-file="{{url('/website/public/images/' . $data->icon)}}" value="">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br><br>
                                <a class="btn btn-danger btn-block" href="{{url('/')}}/admin/categories">رجوع</a>
                            </div>
                        </div>
