            ...
            <form class="" method="post" action="" enctype="multipart/form-data">
                <div class="page-title-box">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item active">التحكم بالسلايدر</li>
                    </ol>
                    <h4 class="page-title">التحكم بالسلايدر</h4>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">إضافة سلايدر</h5>
                                <div class="row">
                                    <div class="col-md-12">
                                        @if (session('success'))
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <label class="control-label">التفاصيل (AR)</label>
                                        <div>
                                            <textarea class="form-control"  name="body_ar" cols="30" rows="7">{{old('body_ar')}}</textarea>
                                        </div>
                                    </div>

                                    <div class="col-md-12 mt-3">
                                        <label class="control-label">التفاصيل (EN)</label>
                                        <div>
                                            <textarea class="form-control"  name="body_en" cols="30" rows="7">{{old('body_en')}}</textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br><br>
                                <a class="btn btn-danger btn-block" href="{{url('/')}}/admin/sliders">رجوع</a>
                            </div>
                        </div>
